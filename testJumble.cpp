...
void testJumble() {
	...
	cout << "Passed memory leak test! \n" << endl;


	//Exception Test
	cout << "Testing Exceptions: \n" << endl;
	cout << "Should give invalid difficulty exception:" << endl;
	try {
			JumblePuzzle test1("exception", "nondiff");
	...
	JumblePuzzle testing2("test2", "easy");
	showJumble(testing2.getJumble(), testing2.getSize());
	cout << "Size should be 5 * 2: " << testing2.getSize() << endl;
	cout << "Row #: " << testing2.getRowPos() << endl;
	cout << "Column #: " << testing2.getColPos() << endl;
	cout << "Direction: " << testing2.getDirection() << endl;
	cout << "The row, column and direction should match location of test2" << endl << endl;
